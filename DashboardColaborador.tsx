          ...
          <div className="mt-4">
            ...
            {showReportFor === challenge.id && (
              <div className="mt-3 p-3 bg-purple-50 rounded border border-purple-100 text-sm text-gray-700">
                {challenge.finalEvaluation && (
                  <div className="mb-4 h-56 w-full bg-white rounded-lg pt-2 pb-6 shadow-sm border border-purple-100">
                    <h4 className="font-bold text-center text-purple-800 text-xs mb-1">Rede de Avaliação</h4>
                    <ResponsiveContainer width="100%" height="100%">
                      <RadarChart cx="50%" cy="50%" outerRadius="65%" data={
                        ...
                        <Radar name="Nota Final" dataKey="score" stroke="#9333ea" fill="#a855f7" fillOpacity={0.4} />
                      </RadarChart>
                    </ResponsiveContainer>
                  </div>
                )}
